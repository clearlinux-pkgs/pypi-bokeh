...
Version  : 3.6.1
Release  : 86
URL      : https://files.pythonhosted.org/packages/54/1b/d62004ebe89b3abb1d329710daa92dd13980196b0f7f5ed82036445cc952/bokeh-3.6.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/54/1b/d62004ebe89b3abb1d329710daa92dd13980196b0f7f5ed82036445cc952/bokeh-3.6.1.tar.gz
...
%prep
%setup -q -n bokeh-3.6.1
cd %{_builddir}/bokeh-3.6.1
pushd ..
cp -a bokeh-3.6.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730929669
