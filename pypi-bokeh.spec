...
Version  : 3.7.3
Release  : 93
URL      : https://files.pythonhosted.org/packages/75/18/12d0d6024177ad18ba65deffc363046d0cbafe116f8b964a9efa85d2800f/bokeh-3.7.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/75/18/12d0d6024177ad18ba65deffc363046d0cbafe116f8b964a9efa85d2800f/bokeh-3.7.3.tar.gz
...
%prep
%setup -q -n bokeh-3.7.3
cd %{_builddir}/bokeh-3.7.3
pushd ..
cp -a bokeh-3.7.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747059560
