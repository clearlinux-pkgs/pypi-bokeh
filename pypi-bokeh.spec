...
Version  : 3.2.2
Release  : 68
URL      : https://files.pythonhosted.org/packages/b2/b5/7b422944c31c3259ddf47c854fbdf09bc0c3a64fb9460aac046848234803/bokeh-3.2.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/b2/b5/7b422944c31c3259ddf47c854fbdf09bc0c3a64fb9460aac046848234803/bokeh-3.2.2.tar.gz
...
%prep
%setup -q -n bokeh-3.2.2
cd %{_builddir}/bokeh-3.2.2
pushd ..
cp -a bokeh-3.2.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1692026611
