...
Version  : 3.5.1
Release  : 82
URL      : https://files.pythonhosted.org/packages/65/b4/564c478256e853d165b49bad48d2d3525c3386a9aa135fc61ee1192efd70/bokeh-3.5.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/65/b4/564c478256e853d165b49bad48d2d3525c3386a9aa135fc61ee1192efd70/bokeh-3.5.1.tar.gz
...
%prep
%setup -q -n bokeh-3.5.1
cd %{_builddir}/bokeh-3.5.1
pushd ..
cp -a bokeh-3.5.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722006447
