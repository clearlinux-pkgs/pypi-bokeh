...
Version  : 3.6.2
Release  : 87
URL      : https://files.pythonhosted.org/packages/da/9d/cc9c561e1db8cbecc5cfad972159020700fff2339bdaa316498ace1cb04c/bokeh-3.6.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/da/9d/cc9c561e1db8cbecc5cfad972159020700fff2339bdaa316498ace1cb04c/bokeh-3.6.2.tar.gz
...
%prep
%setup -q -n bokeh-3.6.2
cd %{_builddir}/bokeh-3.6.2
pushd ..
cp -a bokeh-3.6.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1733324851
