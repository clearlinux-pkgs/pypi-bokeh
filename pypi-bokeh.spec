...
Version  : 3.7.0
Release  : 90
URL      : https://files.pythonhosted.org/packages/02/b3/a2777b52f03d152aa1645b96b5c2028bf88a91d9b3894db14f53ef54c1de/bokeh-3.7.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/02/b3/a2777b52f03d152aa1645b96b5c2028bf88a91d9b3894db14f53ef54c1de/bokeh-3.7.0.tar.gz
...
%prep
%setup -q -n bokeh-3.7.0
cd %{_builddir}/bokeh-3.7.0
pushd ..
cp -a bokeh-3.7.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742453807
