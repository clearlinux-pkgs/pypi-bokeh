...
Source0  : https://files.pythonhosted.org/packages/d6/9d/c8a7842fbf0e3542a6108b6025e906a18ebe977fdbca9763fd01a3330670/bokeh-3.4.1.tar.gz
...
%prep
%setup -q -n bokeh-3.4.1
cd %{_builddir}/bokeh-3.4.1
pushd ..
cp -a bokeh-3.4.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712935904
