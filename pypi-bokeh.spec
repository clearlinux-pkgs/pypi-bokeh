...
Source0  : https://files.pythonhosted.org/packages/34/85/f9dba9dcd482707dc3ece53997689c0aea5fc70fe08ae99d1886bd5bd291/bokeh-3.4.0.tar.gz
...
%prep
%setup -q -n bokeh-3.4.0
cd %{_builddir}/bokeh-3.4.0
pushd ..
cp -a bokeh-3.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710805861
