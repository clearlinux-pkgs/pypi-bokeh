...
Source0  : https://files.pythonhosted.org/packages/d4/91/df53287e2f34c7cd6262b3b31c4dd4d274c78b7ece20cf0736bc4a21ab85/bokeh-3.4.2.tar.gz
...
%prep
%setup -q -n bokeh-3.4.2
cd %{_builddir}/bokeh-3.4.2
pushd ..
cp -a bokeh-3.4.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719328950
